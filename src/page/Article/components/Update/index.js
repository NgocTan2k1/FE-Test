...
import { UpdateArticleApi } from '../../../../services/auth';
...
function Update() {
    ...
    const handleFinish = async (values) => {
        ...
        if (values.title && values.description && values.body && values.slug) {
            const data = {
                title: values.title,
            ...
            UpdateArticleApi(values.slug, data)
                .then((response) => {
            ...
            <div className={cx('container-form')}>
                ...
                >
                    <div className={cx('container-form-item')}>
                        <Form.Item className={cx('form-item')} label="Slug" name="slug">
                            <Input className={cx('item-input')} />
                        </Form.Item>
                        {slug ? <div className={cx('error')}>Slug cannot be left blank</div> : ''}
                    </div>
                    <div className={cx('container-form-item')}>
